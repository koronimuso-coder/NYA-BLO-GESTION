...
import { Plus, Building2, MapPin, Phone, Mail, TrendingUp, Users, Sparkles, ArrowRight } from "lucide-react";
...
const companies = [
  ...
  },
  {
    id: "2",
    name: "NB FLOWERS",
    sector: "Décoration & Fleurs",
    address: "Cocody, Abidjan",
    phone: "+225 05 00 00 00 00",
    email: "hello@nbflowers.com",
    staffCount: 5,
    sales: "2,850,000",
    status: "Actif"
  },
  ...
  return (
    <div ref={container} className="space-y-8 pb-12 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
        {[
          { label: "Total Filiales", value: "24", icon: Building2, color: "bg-[#5C3D2E]" },
          { label: "Performance Globale", value: "+28%", icon: TrendingUp, color: "bg-[#A66037]" },
          { label: "Forces de Vente", value: "142", icon: Users, color: "bg-[#D4AF37]" },
        ].map((stat, i) => (
          ...
          <div key={company.id} className="company-card bg-white rounded-[40px] shadow-premium border border-[#E8DCC4] overflow-hidden flex flex-col hover:border-[#D4AF37]/50 transition-all group">
            ...
            <div className="mt-auto px-8 py-6 bg-[#FAF3E0]/30 border-t border-[#E8DCC4]/50 flex items-center justify-between">
               <div className="flex flex-col">
                  ...
                  <span className="font-bold text-[#5C3D2E] text-lg">{company.sales} <span className="text-[10px]">FCFA</span></span>
               </div>
