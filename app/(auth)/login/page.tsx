...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-dogon-nuit flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      {/* Background Ornaments (Dogon Theme) */}
      ...
      >
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight text-dogon-text">
            NYA BLO BUSINESS OS
          </h2>
          <p className="mt-2 text-sm text-dogon-muted">
            Portail de direction centralisé (Firebase Edition)
          </p>
        </div>
        ...
        <div className="mt-8 bg-dogon-card/80 backdrop-blur-sm py-8 px-4 shadow-2xl shadow-black/50 sm:rounded-xl sm:px-10 border border-dogon-sirius">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <label className="block text-sm font-medium text-dogon-muted">
                Adresse email
              </label>
              <div className="mt-1">
                <input
